...
text_file=../../data/t2_pte_train.txt # the text file for training
label_file=../../data/t2_pte_labels.txt # the label file for training
infer_file=../../data/t2_doc_lines.txt # the text file to infer
